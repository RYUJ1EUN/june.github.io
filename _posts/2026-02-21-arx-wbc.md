...
- 화이트박스 구현 기술의 흐름 (Motivation Flow)
    ...
    - 인코딩 상쇄 문제 해결을 위해
        ...
        &
        \overset{\leftrightarrow}{\text{CCZ-equiv} }
        &
        2\text{차 함수 }Q
        \\
        \boxplus\text{의 그래프}
        &
        \overset{\leftrightarrow}{\text{affine-permutation} }
        &
        Q\text{의 그래프}
        \end{matrix}
        $$
...
{\color{red} (E^{(r-1)\;}} &{\color{red}\rightarrow)} \;\, \color{red} \circ 
...
<img src="{{ '/assets/img/post/arx_wbc_1/no_in_encoding_attack_structure_3.png' | relative_url }}" style="max-width: 20%; height: auto; display: block; margin: 0 auto;" alt="no_in_encoding_attack_structure_3">
<!-- ![no_in_encoding_attack_structure_3.png](no_in_encoding_attack_structure_3.png) -->

<img src="{{ '/assets/img/post/arx_wbc_1/no_in_encoding_attack_structure_5.png' | relative_url }}" style="max-width: 20%; height: auto; display: block; margin: 0 auto;" alt="no_in_encoding_attack_structure_5">
...
<img src="{{ '/assets/img/post/arx_wbc_1/no_in_encoding_attack_structure_4.png' | relative_url }}" style="max-width: 90%; height: auto; display: block; margin: 0 auto;" alt="no_in_encoding_attack_structure_4">
...
<img src="{{ '/assets/img/post/arx_wbc_2/affine_round_decompo_1.png' | relative_url }}" style="max-width: 70%; height: auto; display: block; margin: 0 auto;" alt="affine_round_decompo_1">
