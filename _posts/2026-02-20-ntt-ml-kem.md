...
![image]({{ '/assets/img/post_ntt_ml_kem/image.png' | relative_url }})
<!-- ![image.png](image.png) -->
...
![image]({{ '/assets/img/post_ntt_ml_kem/image_1.png' | relative_url }})
<!-- ![image.png](image%201.png) -->

Let $\omega=\psi_{2n}^2$, then $\omega$ is a primitive $n$-th root of unity: $\omega^{n}= (\psi_{2n}^2)^{n}=1$

![image]({{ '/assets/img/post_ntt_ml_kem/image_2.png' | relative_url }})
<!-- ![image.png](image%202.png) -->

![image]({{ '/assets/img/post_ntt_ml_kem/image_3.png' | relative_url }})
...
![image]({{ '/assets/img/post_ntt_ml_kem/14416731-2c31-4e01-9c81-ca220167df77.png' | relative_url }})
<!-- ![image.png](14416731-2c31-4e01-9c81-ca220167df77.png) -->

Gentlemen-Sande butterfly or GS butterfly`Addition → Multiplication`. 

![image]({{ '/assets/img/post_ntt_ml_kem/bc9e4c46-c1a8-4888-8f28-8fab825d7c10.png' | relative_url }})
...
![image]({{ '/assets/img/post_ntt_ml_kem/image_4.png' | relative_url }})
<!-- ![image.png](image%204.png) -->

![image]({{ '/assets/img/post_ntt_ml_kem/image_5.png' | relative_url }})
...
1. Kyber ring은 $\Z_q[x]/(x^n+1)$이므로 NWC-based NTT를 수행하기 위한 primitive $2n$-th root of unity가 필요함
...
4. Kyber ring $\Z_q[x]/(x^{256}+1)$을 $(\Z_q[y]/(y^2-x))[x]/(x^{128}+1)$로 변환함
    1. $n'=128$에 대하여 primitive $2n$-th root of unity가 존재함
    2. FFT를 적용한 point-wise multiplication은 
        
        $(c_0 +c_1 y)(c_0' +c_1' y)\in \Z_q[y]/(y^2-x)$로써 수행됨
...
이는 $\Z_q$ 상에 primitive 256-th root of unity는 존재하지만, primitive 512-th root of unity는 존재하지 않음을 의미
...
이는 Kyber ring에서 정의된 다항식 $a(x)\in \Z_q[x]/(x^n+1)$를 $y = x^{2^\beta} = x^2$로 치환하여 $y$에 대한 다항식
...
$$
\mathbb{Z}_q[x]/(x^n+1) \to \left(\Z_q[x]/(x^{2^\beta} - y)\right)[y]/(y^{n/2^\beta} +1)
$$
...
$$
\mathbb{Z}_q[x]/(x^{256}+1) \to \left(\Z_q[x]/(x^{2} - y)\right)[y]/(y^{128} +1)
$$
...
$$
\mathbb{Z}_q[x]/(x^{256}+1) \to \left(\Z_q[y]/(y^{2} - x)\right)[x]/(x^{128} +1)
$$
...
![image]({{ '/assets/img/post_ntt_ml_kem/image_6.png' | relative_url }})
...
##### $\bold{Algorithm} \ \color{#0000ff}{\sf NTT}(f)$
...
- Line 8~10
    ...
    ⇒  Point-wise multiplication over $\Z_q[x]/(x^2-\zeta)$ for $\zeta=\omega_i$
